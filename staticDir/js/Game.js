                ...
                if (localTable[i][j] != "") {
                    if (localTable[i][j].color == "white") {
                        if (localTable[i][j].type == "Rook") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/ww.png')";
                        } else if (localTable[i][j].type == "Knight") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/hw.png')";
                        } else if (localTable[i][j].type == "Bishop") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/gw.png')";
                        } else if (localTable[i][j].type == "Queen") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/qw.png')";
                        } else if (localTable[i][j].type == "King") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/kw.png')";
                        } else if (localTable[i][j].type == "Pawn") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/pw.png')";
                        }
                    } else if (localTable[i][j].color == "black") {
                        if (localTable[i][j].type == "Rook") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/wb.png')";
                        } else if (localTable[i][j].type == "Knight") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/hb.png')";
                        } else if (localTable[i][j].type == "Bishop") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/gb.png')";
                        } else if (localTable[i][j].type == "Queen") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/qb.png')";
                        } else if (localTable[i][j].type == "King") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/kb.png')";
                        } else if (localTable[i][j].type == "Pawn") {
                            document.getElementById("x" + (j + 1) + "_y" + (i + 1)).style.backgroundImage = "url('/pb.png')";
                        }
                    }
                } else {
